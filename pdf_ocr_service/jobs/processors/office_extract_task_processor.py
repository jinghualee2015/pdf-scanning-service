...
from pdf_ocr_service.jobs.domains.document_office_task_info import DocumentOfficeTaskInfo
from pdf_ocr_service.celery import task_logger

logger = task_logger


class OfficeExtractTaskProcessor(BaseDocumentProcessor):
    """
    extract office convert pdf document content
    """

    def __init__(self,
                 task_info: DocumentOfficeTaskInfo = None):
        super(OfficeExtractTaskProcessor, self).__init__(task_info=task_info)
